...
<body>
    <div class="container">
        <div class="image">
            <img src="https://m.media-amazon.com/images/I/71u9rNXbS-L.__AC_SX300_SY300_QL70_ML2_.jpg" alt="Computadora">
        </div>
        <div class="info">
            <h1><?php echo "Computadora Portátil"; ?></h1>
            <p><?php echo "Precio: $18000"; ?></p>
